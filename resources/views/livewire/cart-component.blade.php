                                ...
                                <li class="pr-cart-item">
                                    ...
                                    <div class="quantity">
                                        ...
                                        <p class="text-center"> <a href="#"
                                                wire:click.prevent="saveLater('{{ $item->rowId }}')">Save for Later
                                            </a>
                                        </p>
                                    </div>
                ...
                <div class="summary">
                    <div class="order-summary">
                        ...
                        @if (Session::has('coupon'))
                            <p class="summary-info"><span class="title">Discount code:
                            ...
                            <p class="summary-info"><span class="title">tax :{{ config('cart.tax') }}%
                                    code: {{ Session::get('coupon')['code'] }}</span><b
                                    class="index">${{ number_format($texAfterDiscount, 2) }}</b></p>
                    ...
                    <div class="checkout-info">
                        ...
                        <div class="summary-item">
                            <form wire:submit.prevent="ApplayCoupon">
                    ...
                    <ul class="products-cart">
                        @foreach (Cart::instance('saveForLater')->content() as $item)
                            ...
                            <li class="pr-cart-item">
                                ...
                                <div class="delete">
                                    <a href="#" class="btn btn-delete" title=""
                                        wire:click.prevent="destroySave('{{ $item->rowId }}')">
                                        <span>Delete from your cart</span>
                                        <i class="fa fa-times-circle" aria-hidden="true"></i>
                                    </a>
                                </div>
