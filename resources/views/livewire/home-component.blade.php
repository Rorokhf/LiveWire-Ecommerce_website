                    ...
                    <div class="tab-contents">
                        <div class="tab-content-item active" id="digital_1a">
                            ...
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                ...
                                @foreach ($L_products as $L_products)

                                    <div class="product product-style-2 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="{{ route('product.details', ['slug' => $L_products->slug]) }}"
                                                title="{{ $L_products->name }}">
                                                <figure><img
                                                        src="{{ asset('assets/images/products') }}/{{ $L_products->image }}"
                                        ...
                                        <div class="product-info">
                                            <a href="{{ route('product.details', ['slug' => $L_products->slug]) }}"
                                                class="product-name"><span>{{ $L_products->name }}</span></a>
                                            <div class="wrap-price"><span
                                                    class="product-price">${{ $L_products->regular_price }}</span>
                                            </div>
                                        </div>
                                    </div>
