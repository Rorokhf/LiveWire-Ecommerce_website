                        ...
                        <div class="summary-item payment-method">
                            ...
                            <div class="choose-payment-methods">
                                <label class="payment-method">
                                    ...
                                    <span class="payment-desc">pay on delevary</span>
                                </label>
                                <label class="payment-method">
                                    <input name="payment-method" id="payment-method-visa" value="card" type="radio"
                                        wire:model="paymentMode">
                                    <span>Debit / cradit card</span>
                            ...
                            @if (Session::has('checkout'))
                                <p wire:ignore id="processing" class="summary-info grand-total"><span>Grand Total</span>
                                    <span class="grand-total-price">${{ Session::get('checkout')['total'] }}</span></p>
                            @endif

                            @if ($errors->isEmpty())
                                <div
                                    style="font-size:22px; margin-bottom:2opx;padding-left:37px; color:green;display:none;" id="processing">
