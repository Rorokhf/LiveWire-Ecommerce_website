                         ...
                         <div class="wrap-right">
                             ...
                             <div class="sort-item orderby ">
                                 <select name="orderby" class="use-chosen" wire:model="sorting">
                                     <option value="menu_order" value="default" selected="selected">Default sorting
                                     </option>
                             ...
                             <ul class="list-category">
                                 @foreach ($categories as $category)
                                     <li
                                         ...
                                         <a href="{{ route('product.categoy', ['category_slug' => $category->slug]) }}"
                                             ...
                                             <ul class="sub-cate">
                                                 @foreach ($category->subcategories as $subcategory)
                                                     <li class="category-item">
                                                         <a href="{{ route('product.categoy', ['category_slug' => $category->slug, 'subcategory_slug' => $subcategory->slug]) }}"
                                                             class="cat-link"><i
