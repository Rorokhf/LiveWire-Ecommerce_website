                ...
                <div class="wrap-product-detail">
                    <div class="detail-media">
                        <div class="product-gallery" wire:ignore>
                            <ul class="slides">
                                ...
                                <li data-thumb="{{ asset('assets/images/products') }}/{{ $imagee }}">
                                    <img src="{{ asset('assets/images/products') }}/{{ $imagee }}"
                                        alt="{{ $product->name }}" />
                                </li>
                                @endforeach
                            </ul>
                    ...
                    <div class="detail-info">
                        <div class="product-rating">
                            ...
                            @php $avrgRating=0; @endphp
                            @foreach ($product->orderItem->where('restatus', 1) as $orderItem)
                                @php $avrgRating= $avrgRating +$orderItem->review->rating; @endphp
                            @endforeach
                            @for ($i = 1; $i <= 5; $i++)
                                ...
                                @endif
                            @endfor
                            <a href="#" class="count-review">({{ $product->orderItem->where('restatus', 1)->count() }}
                                review)</a>
                        </div>
                        ...
                        <div>
                            @foreach ($product->attrbuteValue as $av)
                            ...
                            <div class="row" style="margin-top: 20px ">
                                ...
                                <div class="col-xs-10">
                                    <select class="form-control" style="width: 200px" wire:model="satt.{{$av->productAttribute->name}}">
                                        @foreach ($av->productAttribute->attrbuteValue->where('product_id',$product->id) as $pav)
                                        <option value="{{$pav->value}}">{{$pac->value}}</option>
                        ...
                        <div class="quantity" style="margin-top: 20px;">
                            ...
                            <div class="quantity-input">
                                ...
                                <a class="btn btn-reduce" href="#" wire:click.prevent="decrease"></a>
                                ...
                                <div class="wrap-review-form">
                                    ...
                                    <div id="comments">
                                        <h2 class="woocommerce-Reviews-title">
                                            {{ $product->orderItem->where('restatus', 1)->count() }} review for
                                            ...
                                            @foreach ($product->orderItem->where('restatus', 1) as $orderItem)
                                                <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1"
                                                    ...
                                                    <div id="comment-20" class="comment_container">
                                                        <img alt="{{$orderItem->order->user->name}}" src="{{asset('assets/images/profile')}}/{{$orderItem->order->user->profile->image}}" height="80"
                                                            width="80">
